...
namespace SickscoreGames.HUDNavigationSystem
{
	public class HNSDocumentation : EditorWindow
	{
		...
		{
			// open online documentation
			string publisherPath = System.IO.Path.Combine(Application.dataPath, HNS.PublisherName);
			string assetPath = System.IO.Path.Combine(publisherPath, HNS.Name.Replace(' ', '-'));
			string docsPath = System.IO.Path.Combine(assetPath, "Documentation.pdf");
