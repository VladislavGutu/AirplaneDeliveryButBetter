...
namespace SickscoreGames.HUDNavigationSystem
{
	...
	public static class HNSMapProfileUtilities
	{
		...
		public static void CreateProfile (string mapTexturePath, Vector2 mapTextureSize, Color mapBackground, Bounds mapBounds)
		{
			...
			string path = System.IO.Path.Combine (System.IO.Path.GetDirectoryName (mapTexturePath), System.IO.Path.GetFileNameWithoutExtension (mapTexturePath).Replace ("_Map", "")).Replace ('\\', '/');
